...
export default function Category () {
    return (
        <div className="flex flex-col gap-10 mt-36 items-center">
            ...
            {categoriesCard.map((card, index) => (
                  ...
                  <div className=" w-1/2 h-full mobile:order-1 mobile:w-full">
                     <div className="flex flex-col px-8 py-8 gap-3">
                       <h2 className="text-green-600 text-sm">LIMIT EDITION</h2>
                        ...
                        <span className="text-gray-300">Finds Gun that are right for your Game.</span>
              ...
              <div className="flex flex-row items-center gap-4">
                ...
                <span className="bg-white px-2 py-1 font-semibold">05</span>
                    ...
                    <button type="submit" className="bg-green-600 rounded-md w-[20%] mobile:w-[50%] px-3 py-1 mt-5 text-white">Shop Now</button>
  </div>
  </div>
</div>
